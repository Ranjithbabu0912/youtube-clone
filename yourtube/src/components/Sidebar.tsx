              ...
              <>
                <div className="border-t pt-2 mt-2">
                  <Link href="/video-call">
                    <Button variant="ghost" className="w-full justify-start text-red-600 hover:text-red-700 hover:bg-red-50 dark:hover:bg-red-950/20 font-semibold">
                      <Video className="w-5 h-5 mr-3 animate-pulse" />
                      Video Call
                    </Button>
                  </Link>
                  <Link href="/history">
          ...
          <nav className="space-y-3 flex flex-col items-center pt-2">
            ...
            {user && (
              <>
                <Link
                  href="/video-call"
                  className="flex flex-col items-center gap-1.5 text-[9px] font-semibold text-red-600 hover:bg-red-50 dark:hover:bg-red-950/20 w-full py-3 rounded-lg transition-colors"
                  title="Video Call"
                >
